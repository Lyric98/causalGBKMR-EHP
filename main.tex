% ============================================================================
% CausalBKMR Module Paper
% Target: Environmental Health (Springer/BMC), Software article type
% Template: Bobb et al. 2018 (https://doi.org/10.1186/s12940-018-0413-y)
% ============================================================================
...
% --- Title and authors ------------------------------------------------------
\title{CausalBKMR: R Commands for Time-Varying Environmental Mixtures\\ in the \pkg{causalmixtures} Package}

\author{
Yanran Li$^{1}$, Arce Domingo-Relloso$^{1}$, Zilan Chai$^{1,2}$,\\
Ana Navas-Acien$^{3}$, Brent A.\ Coull$^{4}$, and Linda Valeri$^{1,5}$\\[0.5em]
\small $^{1}$Department of Biostatistics, Columbia University Mailman School of Public Health, New York, NY, USA\\
\small $^{2}$Microsoft, Redmond, WA, USA\\
\small $^{3}$Department of Environmental Health Sciences, Columbia University Mailman School of Public Health, New York, NY, USA\\
\small $^{4}$Department of Biostatistics, Harvard T.H.\ Chan School of Public Health, Boston, MA, USA\\
